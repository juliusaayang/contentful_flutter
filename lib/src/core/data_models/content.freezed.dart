...
mixin _$Content {
  ...
  Data? get data; // ignore: invalid_annotation_target
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.subContent, subContent) &&
  ...
  int get hashCode => Object.hash(
      ...
      parentNodeType,
      data,
      const DeepCollectionEquality().hash(subContent),
...
extension ContentPatterns on Content {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _Content() when $default != null:
        return $default(_that.nodeType, _that.parentNodeType, _that.data,
            _that.subContent, _that.marks, _that.value);
      case _:
        return orElse();
    }
  }
