...
@JsonKey(name: 'Asset') List<Asset>? get assetList;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Includes&&const DeepCollectionEquality().equals(other.assetList, assetList));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(assetList));
...
/// Create a copy of Includes
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? assetList = freezed,}) {
  return _then(_self.copyWith(
assetList: freezed == assetList ? _self.assetList : assetList // ignore: cast_nullable_to_non_nullable
as List<Asset>?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'Asset')  List<Asset>? assetList)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Includes() when $default != null:
return $default(_that.assetList);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'Asset')  List<Asset>? assetList)  $default,) {final _that = this;
switch (_that) {
case _Includes():
return $default(_that.assetList);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'Asset')  List<Asset>? assetList)?  $default,) {final _that = this;
switch (_that) {
case _Includes() when $default != null:
return $default(_that.assetList);case _:
  return null;
...
class _Includes implements Includes {
  const _Includes({@JsonKey(name: 'Asset') final  List<Asset>? assetList}): _assetList = assetList;
  factory _Includes.fromJson(Map<String, dynamic> json) => _$IncludesFromJson(json);

// ignore: invalid_annotation_target
 final  List<Asset>? _assetList;
// ignore: invalid_annotation_target
@override@JsonKey(name: 'Asset') List<Asset>? get assetList {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Includes&&const DeepCollectionEquality().equals(other._assetList, _assetList));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_assetList));
...
/// Create a copy of Includes
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? assetList = freezed,}) {
  return _then(_Includes(
assetList: freezed == assetList ? _self._assetList : assetList // ignore: cast_nullable_to_non_nullable
as List<Asset>?,
  ));
}
